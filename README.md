...
The per-platform `NOTICES.<platform>.txt` files (e.g. [`NOTICES.windows.txt`](NOTICES.windows.txt)) have grown past 200,000 lines (~1,000+ components). To find any single component, use the **Table of Contents at the top of the file** — every component is listed alphabetically with the line number where its block starts. For markdown reading, [`NOTICES.windows.md`](NOTICES.windows.md) opens with a clickable per-component TOC linking to anchor headings. Ad-hoc Ctrl-F in the GitHub raw viewer is brittle at this file size; the TOC is faster and reliable. (Linux has its own `NOTICES.linux.*`, in preparation.)
...
| RC-1-Gold-0.76 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.76](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.76) | 1000 |
| RC-1-Gold-0.75 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.75](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.75) | 1000 |
| RC-1-Gold-0.74 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.74](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.74) | 1000 |
| RC-1-Gold-0.73 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.73](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.73) | 1000 |
| RC-1-Gold-0.72 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.72](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.72) | 1000 |
| RC-1-Gold-0.71 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.71](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.71) | 1000 |
| RC-1-Gold-0.70 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.70](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.70) | 1000 |
| RC-1-Gold-0.69 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.69](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.69) | 1000 |
| RC-1-Gold-0.68 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.68](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.68) | 999 |
| RC-1-Gold-0.67 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.67](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.67) | 999 |
| RC-1-Gold-0.66 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.66](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.66) | 999 |
| RC-1-Gold-0.65 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.65](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.65) | 999 |
| RC-1-Gold-0.64 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.64](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.64) | 999 |
| RC-1-Gold-0.63 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.63](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.63) | 999 |
| RC-1-Gold-0.62 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.62](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.62) | 998 |
| RC-1-Gold-0.61 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.61](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.61) | 998 |
| RC-1-Gold-0.60 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.60](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.60) | 998 |
| RC-1-Gold-0.59 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.59](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.59) | 998 |
| RC-1-Gold-0.58 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.58](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.58) | 998 |
| RC-1-Gold-0.54 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.54](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.54) | 998 |
| RC-1-Gold-0.53 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.53](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.53) | 998 |
| RC-1-Gold-0.52 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.52](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.52) | 998 |
| RC-1-Gold-0.51 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.51](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.51) | 998 |
| RC-1-Gold-0.50 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.50](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.50) | 998 |
| RC-1-Gold-0.49 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.49](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.49) | 998 |
| RC-1-Gold-0.47 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.47](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.47) | 998 |
| RC-1-Gold-0.46 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.46](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.46) | 998 |
| RC-1-Gold-0.45 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.45](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.45) | 998 |
| RC-1-Gold-0.44 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.44](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.44) | 998 |
| RC-1-Gold-0.43 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.43](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.43) | 996 |
...
| RC-1-Gold-0.37 | CycloneDX 1.5 JSON | [releases/RC-1-Gold-0.37](https://github.com/rAIdio-bot/sbom/tree/main/releases/RC-1-Gold-0.37) | 996 |
